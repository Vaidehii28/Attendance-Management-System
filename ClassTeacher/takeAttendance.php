...
//session and Term
        ...
        // Check if a date is selected in the date option
        if (isset($_POST['attendanceDate']) && !empty($_POST['attendanceDate'])) {
            // Use the selected date for attendance
            ...
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <button type="submit" name="save" class="btn btn-primary ml-2">Take Attendance</button>
                        <div class="ml-2 mt-4">
        <h6 class="m-0 font-weight-bold text-primary">Attendance Date:</h6>
        <input type="date" name="attendanceDate" class="form-control form-control-sm">
    </div>
                    </div>
                </div>
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
